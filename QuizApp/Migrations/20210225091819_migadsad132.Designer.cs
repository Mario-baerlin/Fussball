...
namespace QuizApp.Migrations
{
    ...
    [Migration("20210225091819_migadsad132")]
    partial class migadsad132
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuizApp.Data.Match", b =>
                {
                    ...
                    b.HasIndex("SelectedPersonId");

                    b.ToTable("match");
                });

            modelBuilder.Entity("QuizApp.Data.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("QuizApp.Data.Match", b =>
                {
                    b.HasOne("QuizApp.Data.Person", "SelectedPerson")
                        .WithMany()
                        .HasForeignKey("SelectedPersonId");
                });
